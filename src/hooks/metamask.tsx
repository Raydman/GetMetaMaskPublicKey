...
export const MetaMaskContext = React.createContext<IamMetaMaskMain | null>(null)

export const MetaMaskProvider: FunctionComponent<{ children?: any }> = ({ children }) => {
